...
- Offline cover caching and locally stored media metadata.
- Work relationship/franchise data.
- Character, voice-actor, staff, studio, alternate-title, episode, and song data models.
- Work detail, character, person, and relationship pages.
- Configurable dark desktop theme.
- Library card sizing, spacing, hover, and resize animation preferences.
- Maximized startup preference.
- Scrollable settings page for smaller screens and window sizes.
...
Future changes will be listed here before the next beta release.
